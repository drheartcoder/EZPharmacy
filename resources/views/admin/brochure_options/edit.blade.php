               ...
               <form name="validation-form" id="validation-form" method="POST" class="form-horizontal" action="{{$module_url_path}}/update" enctype="multipart/form-data">
                  ...
                  <div id="myTabContent1" class="tab-content">
                     ...
                     <?php 
                        ...
                        {
                            $option_name = isset($arr_data['translations'][$lang['locale']]['option_name'])?$arr_data['translations'][$lang['locale']]['option_name']:'' ;
                            $option_desc = isset($arr_data['translations'][$lang['locale']]['option_desc'])?$arr_data['translations'][$lang['locale']]['option_desc']:'' ;
                        }
                       // dd($option_desc);
                     ...
                     <div class="tab-pane fade {{ $lang['locale']=='en'?'in active':'' }}"
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-6 col-lg-9 controls">
                              @if($lang['locale'] == 'en') 
                              <input type="text" name="name_{{$lang['locale']}}" class="form-control" value="{{isset($option_name)?$option_name:''}}" data-rule-required="true" data-rule-maxlength="255" placeholder="{{ $module_title or ''}} Name">
                              @else
                              <input type="text" name="name_{{$lang['locale']}}" class="form-control" value="{{isset($option_name)?$option_name:''}}" placeholder="{{ $module_title or ''}} Name" data-rule-required="" data-rule-maxlength="255">
                              @endif    
                          ...
                          <div class="form-group">
                           ...
                           <div class="col-sm-6 col-lg-9 controls">
                             ...
                             {{isset($option_desc)?$option_desc:''}}
                              </textarea>
                              @else
                              <textarea type="text" name="desc_{{$lang['locale']}}" class="form-control"  placeholder="{{ $module_title or ''}} Description" data-rule-required="" >{{isset($option_desc)?$option_desc:''}}
                              </textarea>
                              @endif    
                  ...
                  <label class="col-sm-3 col-lg-2 control-label"> Image  <i class="red"></i> </label>
                      <div class="col-sm-9 col-lg-10 controls">
                          <div class="fileupload fileupload-new" data-provides="fileupload">
                              ...
                              <img src="{{url('').'/uploads/brochure_options/'.$arr_data['image'] }}">
                              @else
