               ...
               <form name="validation-form" id="validation-form" method="POST" class="form-horizontal" action="{{$module_url_path}}/update" enctype="multipart/form-data">
                  ...
                  <div id="myTabContent1" class="tab-content">
                     ...
                     <?php 
                        ...
                        {
                            $envelope_name = isset($arr_data['translations'][$lang['locale']]['envelope_name'])?$arr_data['translations'][$lang['locale']]['envelope_name']:'' ;
                            $envelope_desc = isset($arr_data['translations'][$lang['locale']]['envelope_desc'])?$arr_data['translations'][$lang['locale']]['envelope_desc']:'' ;
                     ...
                     <div class="tab-pane fade {{ $lang['locale']=='en'?'in active':'' }}"
                        ...
                        <div class="form-group">
                           <label class="col-sm-3 col-lg-2 control-label" for="page_title">{{ $module_title or ''}} Name @if($lang['locale'] == 'en') <i class="red">*</i> @endif</label>
                           <div class="col-sm-6 col-lg-4 controls">
                              @if($lang['locale'] == 'en') 
                              <input type="text" name="name_{{$lang['locale']}}" class="form-control" value="{{isset($envelope_name)?$envelope_name:''}}" data-rule-required="true" data-rule-maxlength="255" placeholder="{{ $module_title or ''}} Name">
                              @else
                              <input type="text" name="name_{{$lang['locale']}}" class="form-control" value="{{isset($envelope_name)?$envelope_name:''}}" placeholder="{{ $module_title or ''}} Name" data-rule-required="" data-rule-maxlength="255">
                              @endif    
                         ...
                         <div class="form-group">
                           <label class="col-sm-3 col-lg-2 control-label" for="page_title">{{ $module_title or ''}} Description @if($lang['locale'] == 'en') <i class="red">*</i> @endif</label>
                           <div class="col-sm-6 col-lg-9 controls">
                               @if($lang['locale'] == 'en') 
                              <textarea type="text" name="desc_{{$lang['locale']}}" class="form-control" data-rule-required="true"  placeholder="{{ $module_title or ''}} Description">
                             {{isset($envelope_desc)?$envelope_desc:''}}
                              </textarea>
                              @else
                              <textarea type="text" name="desc_{{$lang['locale']}}" class="form-control"  placeholder="{{ $module_title or ''}} Description" data-rule-required="" >{{isset($envelope_desc)?$envelope_desc:''}}
                              </textarea>
                              @endif    
                  ...
                  <label class="col-sm-3 col-lg-2 control-label"> Image  <i class="red">*</i> </label>
                      <div class="col-sm-9 col-lg-10 controls">
                          <div class="fileupload fileupload-new" data-provides="fileupload">
                              ...
                              <img src="{{url('').'/uploads/envelope/'.$arr_data['image'] }}">
                              @else
                             ...
                             @endif
                              ...
                              <div>
                                  <span class="btn btn-default btn-file" style="height:32px;">
                                      ...
                                      <input type="hidden" class="file-input " name="oldimage" id="oldimage" data-rule-required="false" 
              ...
              {              
                    ...
                    reader.onload = function (e) 
                    {
                            ...
                            image.onload = function () 
                            {
                                ...
                                {
                                    swal("Height and Width must be equal to  770 X 400 .",'error');
                                    $(".fileupload-preview").html("");
                                    $(".fileupload").attr('class',"fileupload fileupload-new");
                                    $("#image").val();
                                    return false;
