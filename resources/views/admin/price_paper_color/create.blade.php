             ...
             {{ csrf_field() }}
                        ...
                        <select class="form-control" name="color" id="color" required="">
                          ...
                          @if(count($color_arr) > 0)
                            @foreach($color_arr as $color_arr_value)
                              <option value="{{ $color_arr_value->id or '' }}">{{ $color_arr_value->color_name or 'N/A' }}</option>
                            @endforeach
                          @endif
                        </select>
                  ...
                  <div class="form-group">
                     <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2">
                        <input type="submit" id="btn_submit" value="Save" class="btn btn btn-primary" name="btn_add_price_color" id="btn_add_price_color">
