            ...
            <div class="box-content">
              ...
              <div id="myTabContent1" class="tab-content">
                  <div class="form-group">
                    <label class="col-sm-3 col-lg-2 control-label" for="cmb_city">City <i class="red">*</i></label>
                    <div class="col-sm-6 col-lg-4 controls">
                        <select class="form-control" id="cmb_city" name="cmb_city">
                          <option value="" selected>Select City</option>
                          @if(count($arr_city) > 0)
                            @foreach($arr_city as $c_data)
                              <option value="{{ $c_data->id }}">{{ $c_data->city_title }}</option>
                            @endforeach
                          @endif
                        </select>
                    </div>
                  ...
                  <div class="form-group">
                    <label class="col-sm-3 col-lg-2 control-label" for="txt_area">Area <i class="red">*</i></label>
                    <div class="col-sm-6 col-lg-4 controls">
                        <input type="text" class="form-control" id="txt_area" name="txt_area" placeholder="Enter Area" >
                    </div>
                  </div>
              </div>
              <br/>
