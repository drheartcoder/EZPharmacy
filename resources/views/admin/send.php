...
$mobile = "966599139318";							//Mobile number (or username) of your Mobily.ws account
$password = "123456789";							//Password of your Mobily.ws account
$sender = "WEBWING";					//The sender name that will be shown when the message is delivered , it will be encrypted automatically to (urlencode)

$numbers = "919923266699";							//the mobile number or set of mobiles numbers that the SMS message will be sent to them, each number must be in international format, without zeros or symbol (+), and separated from others by the symbol (,).
$msg = "test sms";		/*
										Messages text.
