              ...
              <tbody>
                ...
                @if(sizeof($arr_data)>0)
                  ...
                  <tr>
                    ...
                    <td > {{ $data['translations'][0]['question'] }} </td> 
                    <td>  <?php echo str_limit(strip_tags( $data['translations'][0]['answer']),12) ;?> </td>
                    ...
                    <td style="width: 100px;"> 
                        <a class="btn btn-primary btn-sm show-tooltip" href="{{ $module_url_path.'/edit/'.base64_encode($data['id']) }}" title="Edit">
                          <i class="fa fa-edit" ></i>
                        </a>  
                          
                        <a class="btn btn-danger btn-sm show-tooltip" href="{{ $module_url_path.'/delete/'.base64_encode($data['id']) }}"  
