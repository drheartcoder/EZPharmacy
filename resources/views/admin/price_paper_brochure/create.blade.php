            ...
            <form name="validation-form" id="validation-form" method="POST" class="form-horizontal" enctype="multipart/form-data">
             {{ csrf_field() }}
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-6 col-lg-4 controls">   
                       <select class="form-control" name="brochure" id="brochure" required="">
                          <option value="">Select Brochure</option>
                          @if(count($brochure_arr) > 0)
                            @foreach($brochure_arr as $brochure_arr_value)
                              <option value="{{ $brochure_arr_value->id or '' }}">{{ $brochure_arr_value->option_name or 'N/A' }}</option>
                            @endforeach
                          @endif
                        </select>
                  ...
                  <div class="form-group">
                     <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2">
                        <input type="submit" id="btn_submit" value="Save" class="btn btn btn-primary" name="btn_add_price_brochure" >
