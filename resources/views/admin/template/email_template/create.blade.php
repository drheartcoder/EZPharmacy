    ...
    <div class="box {{ $theme_color }}">
      <div class="box-title">
        ...
        @include('admin.layout._operation_status')
          ...
          <div class="tabbable">
          <form method="POST" id="validation-form" class="form-horizontal" action="{{$module_url_path}}/email_template/store" enctype="multipart/form-data">
                        ...
                        @foreach($arr_lang as $lang)
                            ...
                            <div class="tab-pane fade {{ $lang['locale']=='en'?'in active':'' }}"     id="{{ $lang['locale'] }}">
                               ...
                               <div class="form-group">
                                  ...
                                  @if($lang['locale'] == 'en')      
                                    <input type="text" name="template_name_{{$lang['locale']}}" required=""  placeholder="Email Template Name" value="{{old('template_name_'.$lang['locale']) or ''}}"  class="form-control add-stundt"/>
                                  @else
                                    <input type="text" name="template_name_{{$lang['locale']}}"  placeholder="Email Template Name" value="{{old('template_name_'.$lang['locale']) or ''}}"  class="form-control add-stundt"/>
                                  @endif  
                                  </div>
