...
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="{{ url('/') }}/assets/font-awesome/css/font-awesome.min.css">
        <!--page specific css styles-->
        <link type="text/css" rel="stylesheet" type="text/css" href="{{ url('/') }}/assets/chosen-bootstrap/chosen.min.css">
        <!--flaty css styles-->
        <link type="text/css" rel="stylesheet" href="{{ url('/') }}/css/admin/flaty.css">
        <link type="text/css" rel="stylesheet" href="{{ url('/') }}/css/admin/flaty-responsive.css">
        <link type="text/css" rel="shortcut icon" href="{{ url('/') }}/img/favicon.png">
        <style type="text/css">
        .error
        {
            color: red;
