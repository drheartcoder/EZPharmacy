              ...
              <div id="myTabContent1" class="tab-content">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-lg-8 controls">
                    ...
                    @if($lang['locale'] == 'en')        
                        {!! Form::textarea('page_desc_'.$lang['locale'],$locale_page_desc,['class'=>'form-control','data-rule-required'=>'true','placeholder'=>'Page Content','id'=>'page_desc_en']) !!}
                    @else
                        {!! Form::textarea('page_desc_'.$lang['locale'],$locale_page_desc,['class'=>'form-control','placeholder'=>'Page Content','id'=>'page_desc_ar']) !!}
                    @endif
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function()
    {
      tinymce.init({
        ...
        valid_elements : '*[*]',
        toolbar: 'insertfile undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | fontselect ',
        image_advtab: false,
