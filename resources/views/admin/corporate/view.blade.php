    ...
    <div class="box ">
      ...
      <div class="box-content">
        <?php 
          ...
          $company_name       = isset($arr_consumer['user_details']['company_name']) ?$arr_consumer['user_details']['company_name']:"NA ";
          $company_email       = isset($arr_consumer['user_details']['company_email']) ?$arr_consumer['user_details']['company_email']:"NA ";
            ...
            <div class="form-group" style="margin-top: 15px;">
              ...
              <div class="col-md-8">
                ...
                <tbody>
                  ...
                  <tr>
                    <th style="width: 30%">Company Email
                    </th>
                    <td>
                      {{$company_email or ''}}
                    </td>
