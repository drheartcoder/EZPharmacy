         ...
         <div class="box-content">
            ...
            <form name="frm_manage" id="frm_manage" method="POST" class="form-horizontal" action="{{$module_url_path}}/multi_action">
               ...
               <div class="table-responsive" style="border:0">
                  ...
                  <table class="table table-advance" <?php if(count($weight_gsm_arr) > 0){ ?> id="table1" <?php } ?> >
                     <thead>
                        <tr>
                     ...
                     <tbody>
                        @if(isset($weight_gsm_arr) && sizeof($weight_gsm_arr)>0)
                          @foreach($weight_gsm_arr as $data)
                          <?php
                            $is_used = array();
                            $is_used = \DB::table('order_master as OM')->select('paper_weight')->where('paper_weight', '=', $data->primaryKey)->get();
                          ?>
                          <tr>
