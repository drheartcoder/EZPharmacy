          ...
          @include('admin.layout._operation_status')
           ...
           <form class="form-horizontal" id="validation-form" method="POST">
            ...
            {{-- <div class="form-group">
                  <label class="col-sm-3 col-lg-2 control-label">Location<i class="red">*</i></label>
                  <div class="col-sm-9 col-lg-7 controls" >
                      <input type="text" class="form-control" name="location" value="{{ old('location') }}" data-rule-required="true" data-rule-maxlength="255" placeholder="Location" />
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                  ...
                  <div class="col-sm-9 col-lg-7 controls" >
                      <input type="text" class="form-control" name="delivery_price" value="{{ old('delivery_price') }}" data-rule-required="true" data-rule-number="true" placeholder="Price" />
            ...
            <div class="form-group">
              <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2">
                <input type="submit" name="btn_add_location" class="btn btn-primary" value="Add">
