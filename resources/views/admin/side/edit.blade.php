               ...
               <form name="validation-form" action="{{$module_url_path.'/update'}}" id="validation-form" method="POST" class="form-horizontal" enctype="multipart/form-data">
                  ...
                  <div id="myTabContent1" class="tab-content">
                     ...
                     <?php 
                        ...
                        //$side_name = isset($arr_data['side_name']) ? $arr_data['side_name'] : "";

                        if(isset($arr_data['translations'][$lang['locale']]))
                        {
                            $side_name = isset($arr_data['translations'][$lang['locale']]['name'])?$arr_data['translations'][$lang['locale']]['name']:'' ;
                        }
                     ?>
                     ...
                     <div class="tab-pane fade {{ $lang['locale']=='en'?'in active':'' }}"
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-6 col-lg-4 controls">
                              @if($lang['locale'] == 'en') 
                              <input type="text" name="name_{{$lang['locale']}}" class="form-control" value="{{isset($side_name)?$side_name:''}}" data-rule-required="true" data-rule-maxlength="255" placeholder="{{ $module_title or ''}} Name">
                              @else
                              <input type="text" name="name_{{$lang['locale']}}" class="form-control" value="{{isset($side_name)?$side_name:''}}" placeholder="{{ $module_title or ''}} Name" data-rule-required="" data-rule-maxlength="255">
                              @endif    
