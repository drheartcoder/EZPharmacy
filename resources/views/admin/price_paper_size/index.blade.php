                  ...
                  <table class="table table-advance" id="table_module" >
                     <thead>
                        <tr>
                           ...
                           <th><a class="sort-desc" href="#">Categoryame </a><input type="text" name="q_category" placeholder="Search" class="search-block-new-table column_filter" /></th>
                           <th><a class="sort-desc" href="#">Size </a><input type="text" name="q_size" placeholder="Search" class="search-block-new-table column_filter" /></th>
                           <th><a class="sort-desc" href="#">Type </a><input type="text" name="q_type" placeholder="Search" class="search-block-new-table column_filter" /></th>
                           <th><a class="sort-desc" href="#">Weight </a> <input type="text" name="q_gsm" placeholder="Search" class="search-block-new-table column_filter" /></th>
                           <th><a class="sort-desc" href="#">Price  ({{currency_code()}})</a><input type="text" name="q_price" placeholder="Search" class="search-block-new-table column_filter" /></th>
                           {{-- <th>Status</th> --}}
                           <th>Action</th>
                        </tr>
                     </thead>
...
<script type="text/javascript">
  ...
  $(document).ready(function()
  {
    table_module = $('#table_module').DataTable({ 
      ...
      bFilter: false ,
      ajax: {
      'url':'{{ $module_url_path.'/loadAllPriceSize/'}}',
      'data': function(d)
        {
          d['column_filter[q_category]']  = $("input[name='q_category']").val()
          d['column_filter[q_size]']      = $("input[name='q_size']").val()
          d['column_filter[q_type]']  = $("input[name='q_type']").val()
          d['column_filter[q_gsm]']   = $("input[name='q_gsm']").val()
      ...
      columns: [
      {
        ...
        {
        return '<input type="checkbox" name="checked_record[]" value="'+row.enc_id+'"/>';
        },
        "orderable": false,
        "searchable":false
      },
      {data: 'category_name', "orderable": true, "searchable":true},
      {data: 'size_name', "orderable": true, "searchable":true},
      {data: 'typeName', "orderable": true, "searchable":true},
      {data: 'weightGSM', "orderable": true, "searchable":true},
