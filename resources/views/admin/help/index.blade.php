              ...
              <tbody>
                ...
                @if(sizeof($arr_contact_enquiry)>0)
                  ...
                  <tr>
                    ...
                    <td > {{ str_limit($contact_enquiry['email'],10) }} </td>   
                    <td > {{ $contact_enquiry['phone'] }} </td> 
                    <td > {{ $contact_enquiry['comp_name'] }} </td> 
                    <td > {{ str_limit($contact_enquiry['subject'],7) }} </td> 
                    <td > {{ str_limit($contact_enquiry['message'],10) }} </td> 

                    <td> @if($contact_enquiry['is_read']==0)
                           <a class="btn btn-sm btn-danger show-tooltip" href="{{ $module_url_path.'/view/'.base64_encode($contact_enquiry['id']) }}" 
