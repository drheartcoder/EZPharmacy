                           ...
                           <div class="form-group"> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 col-lg-4 controls">
                                    <input class="form-control" name="" id=""  value="{{ isset($arr_contact_enquiry['first_name']) && $arr_contact_enquiry['first_name'] !=""  ?ucfirst($arr_contact_enquiry['first_name']):'NA' }}" readonly="" style="background-color : white"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 col-lg-4 controls">
                                    <input class="form-control" name="" id=""  value="{{ isset($arr_contact_enquiry['last_name']) && $arr_contact_enquiry['last_name'] !=""  ?ucfirst($arr_contact_enquiry['last_name']):'NA' }}" readonly="" style="background-color : white"/>
                                </div>
                            </div>
                             ...
                             <div class="form-group">
                                <label class="col-sm-3 col-lg-2 control-label" for="email_id">Company Name</label>
                                <div class="col-sm-6 col-lg-4 controls">
                                    <input class="form-control" name="" id=""  value="{{ isset($arr_contact_enquiry['comp_name']) && $arr_contact_enquiry['comp_name'] !=""  ?ucfirst($arr_contact_enquiry['comp_name']):'NA' }}" readonly="" style="background-color : white" />
                                </div>
                            </div>
                             <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 col-lg-4 controls">
                                    <textarea class="form-control" name="message" id="message" readonly="" style="background-color : white; height: 200px;" >{{ isset($arr_contact_enquiry['message']) && $arr_contact_enquiry['message'] !=""  ?$arr_contact_enquiry['message']:'NA' }}</textarea>
