                  ...
                  <table class="table table-advance"  id="table_module" >
                     <thead>
                        <tr>
                           ...
                           <th><a class="sort-desc" href="#">Size </a>
                            <input type="text" name="q_size" placeholder="Search" class="search-block-new-table column_filter" /></th>
                           <th><a class="sort-desc" href="#">Colour </a>
                            <input type="text" name="q_color" placeholder="Search" class="search-block-new-table column_filter" /></th>
                           <th> <a class="sort-desc" href="#">Price ({{currency_code()}})</a>
...
<script type="text/javascript">
  ...
  $(document).ready(function()
  {
    table_module = $('#table_module').DataTable({ 
      ...
      {data: 'color_name', "orderable": true, "searchable":true},
