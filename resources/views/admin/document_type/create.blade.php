...
<style type="text/css">
  .tabbable .nav-tabs > li.active {z-index:0 !important;}
</style>
<!-- END Page Title -->
<!-- BEGIN Breadcrumb -->
<div id="breadcrumbs">
                    ...
                    <input name="image" type="file" class="hidden tinymce_upload" onchange="">
                     ...
                     <div class="tab-pane fade {{ $lang['locale']=='en'?'in active':'' }}"
                        ...
                        <div class="form-group">
                           <label class="col-sm-3 col-lg-2 control-label" for="skill_name"> Name<i class="red">*</i></label>
                      ...
                      <div class="tab-pane fade {{ $lang['locale']=='en'?'in active':'' }}"
                        id="{{ $lang['locale'] }}">
                        <div class="form-group">
                           <label class="col-sm-3 col-lg-2 control-label" for="skill_name">Description<i class="red">*</i></label>
                           <div class="col-sm-6 col-lg-9 controls">
                              @if($lang['locale'] == 'en') 
