               ...
               <form name="validation-form" id="validation-form" method="POST" class="form-horizontal" action="{{$module_url_path}}/update" enctype="multipart/form-data">
                  ...
                  <div id="myTabContent1" class="tab-content">
                     ...
                     <?php 
                        ...
                        {
                            $type_name = isset($arr_data['translations'][$lang['locale']]['type_name'])?$arr_data['translations'][$lang['locale']]['type_name']:'' ;
                            $type_desc = isset($arr_data['translations'][$lang['locale']]['type_desc'])?$arr_data['translations'][$lang['locale']]['type_desc']:'' ;
                        }
                     ?>
                     ...
                     <div class="tab-pane fade {{ $lang['locale']=='en'?'in active':'' }}"
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-6 col-lg-4 controls">
                              @if($lang['locale'] == 'en') 
                              <input type="text" name="name_{{$lang['locale']}}" class="form-control" value="{{isset($type_name)?$type_name:''}}" data-rule-required="true" data-rule-maxlength="255" placeholder="{{ $module_title or ''}} Name">
                              @else
                              <input type="text" name="name_{{$lang['locale']}}" class="form-control" value="{{isset($type_name)?$type_name:''}}" placeholder="{{ $module_title or ''}} Name" data-rule-required="" data-rule-maxlength="255">
                              @endif    
                         ...
                         <div class="form-group">
                           ...
                           <div class="col-sm-6 col-lg-8 controls">
                             ...
                             {{isset($type_desc)?$type_desc:''}}
                              </textarea>
                              @else
                              <textarea type="text" name="desc_{{$lang['locale']}}" class="form-control"  placeholder="{{ $module_title or ''}} Description" data-rule-required="" >{{isset($type_desc)?$type_desc:''}}
                              </textarea>
                              @endif    
                  ...
                  <label class="col-sm-3 col-lg-2 control-label"> Image  <i class="red">*</i> </label>
                      <div class="col-sm-9 col-lg-10 controls">
                          <div class="fileupload fileupload-new" data-provides="fileupload">
                              ...
                              <img src="{{url('').'/uploads/document_type/'.$arr_data['image'] }}">
                              @else
                             ...
                             @endif
                              ...
                              <i class="red"> Please use greater than 270 x 190 pixel image for best result,<br>
