            ...
            <div class="tab-content">
               <div class="form-group">
                  ...
                  <div class="col-sm-6 col-lg-4 controls">       
                     <input type="text" class="form-control" ddata-rule-alphanumeric="true"  name="type" id="type" data-rule-required="true" data-rule-maxlength="128" placeholder="Paper Type" >
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-lg-4 controls">       
                     <input type="text" class="form-control" name="weight" id="weight" data-rule-number="true" data-rule-required="true" data-rule-maxlength="128" placeholder="Paper Weight" >
               ...
               <div class="form-group">
                  <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2">
                     <input type="submit" name="btn_add" value="Add" class="btn btn btn-primary">
                  </div>
               </div>
         </form>
         </div>
