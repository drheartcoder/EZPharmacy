                  ...
                  <table class="table table-advance"  id="table1" >
                     <thead>
                        <tr>
                           ...
                           <th>{{ $module_title or ''}} Type</th>
                           <th>{{ $module_title or ''}} Size</th>
                           <th>{{ $module_title or ''}} Weight</th>
                           <th>Status</th>
                           <th>Action</th>
                        </tr>
                     </thead>
                     <tbody>
                        @if(isset($arr_data) && sizeof($arr_data)>0)
                          ...
                          <tr>
                             ...
                             <td> {{ isset($data['paper_type'])?$data['paper_type']:'' }} </td>
                             <td> {{ isset($data['paper_size'])?$data['paper_size']:'' }} </td>
                             <td> {{ isset($data['paper_weight'])?$data['paper_weight']:'' }} </td>
