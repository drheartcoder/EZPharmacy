                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12" style="display: none;">
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <div class="email-box-2">
                                        ...
                                        <div class="input-block">
                                            <input type="text" id="txtFromContact" name="txtFromContact" placeholder="<?php echo  (preg_replace('#<[^>]+>#',' ',translation('penter_senders_contact_numberp')));?>" value="{{$userData[0]->mobile_number}}" onkeypress="removeError(this.value,'errorFromContact',this.id);" onblur="removeError(this.value,'errorFromContact',this.id);" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <div class="email-box-2">
                                        ...
                                        <div class="input-block">
                                            <input type="text" id="txtFromEmail" name="txtFromEmail" placeholder="<?php echo  (preg_replace('#<[^>]+>#',' ',translation('penter_senders_emailp')));?>" value="{{$userData[0]->email_address}}" onkeypress="removeError(this.value,'errorFromEmail',this.id);" onblur="removeError(this.value,'errorFromEmail',this.id);" />
                                        </div>
                                    </div>
                                </div>
