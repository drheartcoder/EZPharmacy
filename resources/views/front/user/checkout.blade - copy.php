                    ...
                    <div class="row">
                                ...
                                <div style="position: relative;" >
                                    ...
                                    <div id="collapse1" style="display: none;">
                                        <div class="white-block">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-6">
                                                <div class="email-box-2">
                                                    <div class="email-title errorPostalcode"><?php echo (preg_replace('#<[^>]+>#',' ',translation('postal_code')));?></div>
                                                    <div class="input-block">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12" id="infoAramex" style="display: none;">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12 userShippingDetails">
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <div class="email-box-2">
                                        <div class="email-title errorToContact"><?php echo  (preg_replace('#<[^>]+>#',' ',translation('contact_number')));?></div>
                                        <div class="input-block">
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <div class="email-box-2">
                                        ...
                                        <div class="input-block">
                                            <input type="text" id="txtToCompany" name="txtToCompany" placeholder="<?php echo  (preg_replace('#<[^>]+>#',' ',translation('enter_receivers_company_name')));?>" value="" onkeypress="removeError(this.value,'errorToCompany',this.id);" onblur="removeError(this.value,'errorToCompany',this.id);"/>
                                        </div>
                                    </div>
                                </div>
                                @else
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12" style="display: none;" id="infoPayment" >
                           <div class="email-title"><?php echo (preg_replace('#<[^>]+>#',' ',translation('choose_your_payment_method')));?></div>
