<style type="text/css">
.name-block-user.img-block-user {
  border-radius: 50%;
              ...
              <div class="row login-left-side">
                ...
                <div id="signup_status_msg"></div>
                    ...
                    <div class="mobile-nu-block input-first" ng-class="{ 'has-error': signupForm.lastname.$touched && signupForm.lastname.$invalid }">
                            <input type="text" name="lastname" ng-model="signupuser.lastname" ng-maxlength="100" ng-pattern="/^[a-zA-Z]+$/" ng-required="true" placeholder="<?php echo (preg_replace('#<[^>]+>#',' ',translation('last_name')));?>">
                            <span class="highlight"></span>
    ...
    <div class="row">
      <div class="container">
        ...
        <!--Before login starts here-->
          <div class="col-lg-12 animate-top-menu">
            <nav class="navbar navbar-art">
              <!-- Brand and toggle get grouped for better mobile display -->
              <div class="navbar-header">
                <ul class="nav navbar-nav navbar-right visible-mobile-flex">
                  <li><a href="http://arab.print.celerart.com"><img class="mobile-lang" src="{{url('front-assets')}}/images/ar.png" alt=""></a></li>
                ...
                <a class="navbar-brand visible-mobile-flex" href="#"><img src="{{url('front-assets')}}/images/mobile-logo.svg" alt="Logo"></a>
              </div>
              ...
              <nav class="navbar navbar-art">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown name-block-user">
                      <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                        <span class="img-block-user">
                         ...
                         <img  id="header_profile_img" src="{{ url('/').'/uploads/all_users/'.$loginId.'/profile/thumb_107X107_'.$profile_image}}"/>
                          @endif
                        </span>{{$arr_logged_user['full_name'] or ''}} <span class="icon-arrow_down"></span>
                      </a>
