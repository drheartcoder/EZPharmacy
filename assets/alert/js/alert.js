...
Settings:
    ...
    type      Alert type('info', 'confirm', 'success','warning', 'error', 'prompt') (optional, 'info')
...
Settings:
    ...
    defaults.type      Default alert type('info', 'confirm','success', 'warning', 'error', 'prompt')
...
(function($) {
    ...
    jQuery.alert = {
         ...
         * @param {String}         [options.type='info']             Alert type('info', 'confirm', 'success', 'warning', 'error', 'prompt')
         ...
         * @param   {String}         [options.defaults.type]         Default alert type('info', 'confirm','success', 'warning', 'error', 'prompt')
         ...
         * @param   {Object}         [options.types.success]         Success alert
         * @param   {String}         [options.types.success.title]   Success alert title
         * @param   {Object}         [options.types.success.buttons] Success alert buttons
