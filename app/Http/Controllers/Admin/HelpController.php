...
class HelpController extends Controller
{
    ...
    public function __construct(HelpModel $help)
    {
        ...
        $this->BaseModel            = $this->Help;

		$this->module_url_path 		= url(config('app.project.admin_panel_slug')."/help");
        $this->module_view_folder   = "admin.help";
        $this->module_title         = "Help Enquiry";
    }
	...
	public function view($enc_id)
	{
        ...
        $view_enquiry = $this->BaseModel->where('id',$id)->update(['is_read'=>'1']);  
