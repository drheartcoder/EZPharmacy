...
trait MultiActionTrait
{
     ...
     public function verify($enc_id = FALSE)
    {
        ...
        {
            Flash::success($this->module_title. ' Verify Successfully');
        }
        else
        {
            Flash::error('Problem Occured While '.$this->module_title.' Verify ');
        }
    ...
    public function unverify($enc_id = FALSE)
    {
        ...
        {
            Flash::success($this->module_title. ' Unverify Successfully');
        }
        else
        {
            Flash::error('Problem Occured While '. $this->module_title .' Unverify ');
        }
    ...
    {   
        ...
        if($static_page)
        {
            ...
            return $static_page->update(['is_verified'=>'yes']);
        }
    ...
    {   
        ...
        if($static_page)
        {
            ...
            return $static_page->update(['is_verified'=>'no']);
        }
